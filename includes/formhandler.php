...
//$from='From: '. $email . "(" . $name . ")" . "\r\n" . 'Bcc: nshaki01@seattlecentral.edu' . "\r\n";
// sends bcc to alternate address

//Creates intelligible subject line that shows where it came from
$subject = 'Email from your web site'; // if your client has more than one web site, you can put the site name here. //change your website to your final project page //
...
//Sends email, with elements created above  //UPDATE TO YOUR EMAIL ADDRESS FOR FINAL PROJECT OR RAVENS EMAIL ON A4
mail ('nectar.shakir@gmail.com', $subject, $body, $from);
